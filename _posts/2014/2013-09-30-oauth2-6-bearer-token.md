...
`error` 和 `error_description` 的值必須只能用以下的字元，定義在 [RFC 6749 附錄 A.7](http://tools.ietf.org/html/rfc6749#appendix-A.7) 和 [RFC 6749 附錄 A.8](http://tools.ietf.org/html/rfc6749#appendix-A.8)：
